...
| <a name="input_bastion_additional_security_groups"></a> [bastion\_additional\_security\_groups](#input\_bastion\_additional\_security\_groups) | List of                                                                                                                                                                                |
| additional security groups to attach to the launch template                                                                                    | `list(string)`                                                                                                                                                                         | `[]`           | no                                 |
...
| <a name="input_bucket_force_destroy"></a> [bucket\_force\_destroy](#input\_bucket\_force\_destroy)                                             | The bucket and all objects should be destroyed when                                                                                                                                    |
| using true                                                                                                                                     | `bool`                                                                                                                                                                                 | `false`        | no                                 |
...
| <a name="input_enable_logs_s3_sync"></a> [enable\_logs\_s3\_sync](#input\_enable\_logs\_s3\_sync)                                              | Enable cron job to copy logs to S3                                                                                                                                                     | `bool`         | `true`                             |
| no                                                                                                                                             |
...
| <a name="input_log_standard_ia_days"></a> [log\_standard\_ia\_days](#input\_log\_standard\_ia\_days)                                           | Number of days before moving logs to IA Storage                                                                                                                                        |
| `number`                                                                                                                                       | `30`                                                                                                                                                                                   | no             |
